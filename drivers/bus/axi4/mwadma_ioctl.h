...
#define MWADMA_RX_PBURST            _IO(MWADMA_MAGIC, 8)
#define MWADMA_RX_CONTINUOUS        _IO(MWADMA_MAGIC, 10)
#define MWADMA_RX_GET_NEXT_INDEX    _IO(MWADMA_MAGIC, 12)
#define MWADMA_RX_STOP              _IO(MWADMA_MAGIC, 14)
#define MWADMA_RX_GET_ERROR         _IO(MWADMA_MAGIC, 16)
#define MWADMA_FREE_RX_CHANNEL      _IO(MWADMA_MAGIC, 18)
